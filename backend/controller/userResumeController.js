...
const addResumeData = async (req, res) => {
    const { title, resumeId, userEmail, userName, firstName, lastName, jobTitle, address, phone, email, summary, experience, education, skills, linkedin, github, leetcode } = req.body;
...
const updateResumeData = async (req, res) => {
    const { firstName, lastName, address, jobTitle, phone, email, summary, experience, education, project, skills, linkedin, github, leetcode, course, codingPlatforms, certifications } = req.body;
    const _id = req.params._id;
    console.log(_id);
    try {
        const updatedData = await userResumeModel.findByIdAndUpdate(_id, { firstName, lastName, address, jobTitle, phone, email, summary, experience, project, education, skills, linkedin, github, leetcode, course, codingPlatforms, certifications });
